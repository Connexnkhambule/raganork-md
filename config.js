...
module.exports = {
    VERSION: 'v4.0.0',
    ALIVE: process.env.ALIVE || "https://i.imgur.com/KCnoMM2.jpg Hey {sender}, I'm alive glitch bot 3.o \n Uptime: {uptime}",
    ...
    ANTI_SPAM: process.env.ANTI_SPAM || '265885740192',
    ...
    PMB: process.env.PMB || '_Personal messages allowed, contact owner first_',
    ...
    BOT_INFO: process.env.BOT_INFO || 'glitch bot md;Skl11;0;https://i.imgur.com/P7ziVhr.jpeg;https://chat.whatsapp.com/Dt3C4wrQmt0GG6io1IBIHb',
    RBG_KEY: process.env.RBG_KEY || '',
    ALLOWED: process.env.ALLOWED || '91,94,265',
    NOT_ALLOWED: process.env.ALLOWED || '91,94,212',
    CHATBOT: process.env.CHATBOT || 'off/ on',
    HANDLERS: process.env.HANDLERS || '.,',
    STICKER_DATA: process.env.STICKER_DATA || "ishmael nkhambule",
    BOT_NAME: process.env.BOT_NAME || 'GLITCH BOT 3.0',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined || process.env.AUDIO_DATA === "public" ? 'CONNEX ISHMAEL;NKHAMBULE MD bot;https://i.imgur.com/P7ziVhr.jpeg' : process.env.AUDIO_DATA,
